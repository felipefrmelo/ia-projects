...
start_state_2 = ('5', '8', '7', '6', '_', '4', '3', '2', '1')
f.print_game(start_state_2) # Imprime com sliding-puzzel a tupla passada
f.print_game(('1','2','3','4','5','6','7','8','_'))
start_node_2 = Game(start_state_2, f.get_empty_space(start_state_2), None, 'Start', 0, 0)
print('heusitsica 2:', start_node_2.calc_h2())